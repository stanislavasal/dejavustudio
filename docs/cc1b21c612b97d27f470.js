...
function _loadCards() {
  _loadCards = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var paths, html, _i, _paths, path, response, tempDiv;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            paths = ['/search/search/index.html', '../search/search/index.html', '../../search/search/index.html'];
            html = null;
            _i = 0, _paths = paths;
...
function getCardKeywords(card) {
  var tags = Array.from(card.querySelectorAll('.card-tag')).map(function (tag) {
    return tag.textContent.toLowerCase();
  });
  var dataAttrs = ['theme', 'object', 'whatsinside', 'platform'];
  var attrs = dataAttrs.map(function (attr) {
    return (card.dataset[attr] || '').toLowerCase();
  }).filter(Boolean);
  return [].concat(_toConsumableArray(tags), _toConsumableArray(attrs)).join(' ');
}
        ...
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            filtered = allCards.filter(function (card) {
              return getCardKeywords(card).includes(query);
            });
            ...
            if (filtered.length === 0) {
              ...
              filtered.forEach(function (card) {
                ...
                if (card.parentElement.tagName === 'A') {
                  var link = card.parentElement.cloneNode(false);
