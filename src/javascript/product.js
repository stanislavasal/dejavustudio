...
function updateProductInfo(type) {
    const priceElem = document.querySelector('.product-description .heading-m');
    const descElem = document.querySelector('.product-description .heading-xs');
